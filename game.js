$(document).ready(function() {
    ...
    function moveBlock() {
        const blocks = [
            ...
            new Block(73000, 'yellow', 7, 5),
            new Block(74000, 'blue', 7, 5),
            new Block(75000, 'yellow', 7, 5),
            new Block(76000, 'blue', 7, 5),
            new Block(77000, 'green', 7, 5),
            new Block(78000, 'green', 7, 5),
            new Block(79000, 'yellow', 7, 5),
            new Block(80000, 'yellow', 7, 5),
            new Block(81000, 'green', 7, 5),
            new Block(82000, 'green', 7, 5),
            new Block(83000, 'blue', 7, 5),
            new Block(84000, 'blue', 7, 5),
            new Block(85000, 'blue', 7, 5),
            new Block(86000, 'yellow', 7, 5),
            new Block(87000, 'green', 7, 5),
            new Block(88000, 'green', 7, 5),
            new Block(89000, 'green', 7, 5),
            new Block(90000, 'green', 7, 5),
            new Block(91000, 'yellow', 7, 5),
            new Block(92000, 'blue', 7, 5),
            new Block(93000, 'green', 7, 5),
            new Block(94000, 'yellow', 7, 5),
            new Block(95000, 'blue', 7, 5),
